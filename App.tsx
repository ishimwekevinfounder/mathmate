        ...
        {messages.length === 0 && (
          <div className="flex flex-col items-center justify-center h-full text-center max-w-md mx-auto space-y-6">
            <div className="relative">
              <div className="w-24 h-24 bg-indigo-50 rounded-full flex items-center justify-center mb-2 animate-pulse">
                <Smile className="w-12 h-12 text-indigo-400" />
              </div>
              <Heart className="absolute -top-1 -right-1 w-8 h-8 text-pink-400 fill-pink-400 animate-bounce" />
            </div>
            <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 w-full">
              {[
                ...
                >
                  ...
                  <Star className="w-4 h-4 text-slate-200 group-hover:text-amber-400 transition-colors" />
                </button>
              ))}
            </div>
          </div>
                  ...
                  {msg.type === 'math-solution' && msg.data && (
                    <div className="bg-white rounded-3xl border border-slate-200 shadow-lg overflow-hidden animate-in zoom-in-95 duration-300">
                      <div className="p-5 border-b border-slate-100 bg-indigo-50/40 flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-2 px-4 py-2 bg-white rounded-2xl border border-indigo-100 shadow-sm">
